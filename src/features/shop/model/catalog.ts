...
export const MERCHANTS: Record<string, Merchant> = {
  ...
  m_wilson: {
    id: 'm_wilson',
    name: 'Sushi Bar Wilson',
    area: 'Wilson',
    coord: { lat: 43.6066, lng: 1.4492 },
    rating: 4.7,
    halal: false,
    emoji: '🍣',
  },
  ...
  m_capitole: {
    id: 'm_capitole',
    name: 'Chocolaterie Capitole',
    area: 'Capitole',
    coord: { lat: 43.6031, lng: 1.4419 },
    rating: 5.0,
    halal: false,
    emoji: '🍫',
  },
...
export const DEALS: Deal[] = [
  ...
  },
  {
    ...
    stockLeft: 9,
    endsInSeconds: 600,
    description: 'Saumon, thon, avocat. Préparé à la minute.',
  },
  {
    id: 'd_fruits',
  ...
  {
    id: 'd_chocolat',
    title: 'Ballotin de chocolats',
    merchantId: 'm_capitole',
    category: 'shopping',
    emoji: '🍫',
    tint: '#ECE0D4',
    price: 8.0,
    ...
    stockLeft: 5,
    endsInSeconds: 7200,
    description: 'Pralinés maison, édition limitée.',
  },
  {
    id: 'd_brunch',
