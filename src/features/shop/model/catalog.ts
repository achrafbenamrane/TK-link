...
export const DEALS: Deal[] = [
  ...
  },
  {
    ...
    price: 6.5,
    oldPrice: 11.5,
    unit: 'la place · séance de 19 h 30',
    rating: 4.7,
    stockTotal: 30,
    stockLeft: 9,
    endsInSeconds: 3000,
    description: 'Séance en version originale sous-titrée, salle rarement pleine en semaine.',
    screening: {
      film: 'Le Voyage de Chihiro',
      startsAt: '19:30',
      durationMin: 125,
      genre: 'Animation',
      version: 'VOST',
  ...
  },
  {
    ...
    price: 4.9,
    oldPrice: 11.5,
    unit: 'la place · séance de 22 h 30',
    rating: 4.6,
    stockTotal: 25,
    stockLeft: 3,
    endsInSeconds: 2400,
    description: 'La dernière séance de la soirée, à moitié prix.',
    perk: 'Dernière séance',
    screening: {
      film: 'La Haine',
      startsAt: '22:30',
      durationMin: 98,
